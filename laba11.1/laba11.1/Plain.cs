...
namespace laba11._1
{
    class Plain : Carrier
    {
        ...
        public Plain(int newSpeed, int newCount, int newPrice, int comfort, bool cheap) : base(newPrice, newSpeed, newCount)
        {
        ...
        {
            Console.WriteLine("Скрость самолета равна: " + Speed);
